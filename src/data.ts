...
export const defaultWords1: ExplanationData = [
  {
    category: "1",
    words: [
  ...
  },
  {
    category: "3",
    words: [
      { id: "word-1-3", text: " Big word ", coef: 0.6 },
      { id: "word-2-3", text: "hello world", coef: 0.8 },
      { id: "word-4-3", text: "caramba", coef: 0.97 },
      { id: "word-3-3", text: "all", coef: 0.74 },
      { id: "word-13-3", text: "grand-pa", coef: 0.89 },
      { id: "word-14-3", text: "finger", coef: 0.91 },
      { id: "word-15-3", text: "coffin", coef: 0.8 },
    ],
  },
];
